...
type MsgClient interface {
	...
	RegisterAccount(context.Context, *connect_go.Request[types.MsgRegisterAccount]) (*connect_go.Response[types.MsgRegisterAccountResponse], error)
	ImportPublicKey(context.Context, *connect_go.Request[types.MsgImportPublicKey]) (*connect_go.Response[types.MsgImportPublicKeyResponse], error)
	DeletePublicKey(context.Context, *connect_go.Request[types.MsgDeletePublicKey]) (*connect_go.Response[types.MsgDeletePublicKeyResponse], error)
}
...
func NewMsgClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) MsgClient {
	...
	return &msgClient{
		...
		registerAccount: connect_go.NewClient[types.MsgRegisterAccount, types.MsgRegisterAccountResponse](
			httpClient,
			baseURL+"/sonrhq.core.identity.Msg/RegisterAccount",
			opts...,
		),
		importPublicKey: connect_go.NewClient[types.MsgImportPublicKey, types.MsgImportPublicKeyResponse](
			httpClient,
			baseURL+"/sonrhq.core.identity.Msg/ImportPublicKey",
			opts...,
		),
		deletePublicKey: connect_go.NewClient[types.MsgDeletePublicKey, types.MsgDeletePublicKeyResponse](
			httpClient,
			baseURL+"/sonrhq.core.identity.Msg/DeletePublicKey",
			opts...,
		),
	}
}
...
type msgClient struct {
	...
	registerAccount   *connect_go.Client[types.MsgRegisterAccount, types.MsgRegisterAccountResponse]
	importPublicKey   *connect_go.Client[types.MsgImportPublicKey, types.MsgImportPublicKeyResponse]
	deletePublicKey   *connect_go.Client[types.MsgDeletePublicKey, types.MsgDeletePublicKeyResponse]
}
...
// RegisterAccount calls sonrhq.core.identity.Msg.RegisterAccount.
func (c *msgClient) RegisterAccount(ctx context.Context, req *connect_go.Request[types.MsgRegisterAccount]) (*connect_go.Response[types.MsgRegisterAccountResponse], error) {
	return c.registerAccount.CallUnary(ctx, req)
}

// ImportPublicKey calls sonrhq.core.identity.Msg.ImportPublicKey.
func (c *msgClient) ImportPublicKey(ctx context.Context, req *connect_go.Request[types.MsgImportPublicKey]) (*connect_go.Response[types.MsgImportPublicKeyResponse], error) {
	return c.importPublicKey.CallUnary(ctx, req)
}

// DeletePublicKey calls sonrhq.core.identity.Msg.DeletePublicKey.
func (c *msgClient) DeletePublicKey(ctx context.Context, req *connect_go.Request[types.MsgDeletePublicKey]) (*connect_go.Response[types.MsgDeletePublicKeyResponse], error) {
...
func NewMsgHandler(svc MsgHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/sonrhq.core.identity.Msg/RegisterAccount", connect_go.NewUnaryHandler(
		"/sonrhq.core.identity.Msg/RegisterAccount",
		svc.RegisterAccount,
		opts...,
	))
	mux.Handle("/sonrhq.core.identity.Msg/ImportPublicKey", connect_go.NewUnaryHandler(
		"/sonrhq.core.identity.Msg/ImportPublicKey",
		svc.ImportPublicKey,
		opts...,
	))
	mux.Handle("/sonrhq.core.identity.Msg/DeletePublicKey", connect_go.NewUnaryHandler(
		"/sonrhq.core.identity.Msg/DeletePublicKey",
		svc.DeletePublicKey,
		opts...,
	))
...
func (UnimplementedMsgHandler) RegisterAccount(context.Context, *connect_go.Request[types.MsgRegisterAccount]) (*connect_go.Response[types.MsgRegisterAccountResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("sonrhq.core.identity.Msg.RegisterAccount is not implemented"))
}

func (UnimplementedMsgHandler) ImportPublicKey(context.Context, *connect_go.Request[types.MsgImportPublicKey]) (*connect_go.Response[types.MsgImportPublicKeyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("sonrhq.core.identity.Msg.ImportPublicKey is not implemented"))
}

func (UnimplementedMsgHandler) DeletePublicKey(context.Context, *connect_go.Request[types.MsgDeletePublicKey]) (*connect_go.Response[types.MsgDeletePublicKeyResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("sonrhq.core.identity.Msg.DeletePublicKey is not implemented"))
}
