...
type MsgCreateDidDocument struct {
	...
	Primary     *Identification   `protobuf:"bytes,2,opt,name=primary,proto3" json:"primary,omitempty"`
	Blockchains []*Identification `protobuf:"bytes,3,rep,name=blockchains,proto3" json:"blockchains,omitempty"`
...
func (m *MsgCreateDidDocument) GetPrimary() *Identification {
	if m != nil {
		return m.Primary
	}
	return nil
...
func (m *MsgCreateDidDocument) GetBlockchains() []*Identification {
	if m != nil {
...
func (m *MsgUpdateDidDocument) GetPrimary() *Identification {
	if m != nil {
		return m.Primary
	}
	return nil
...
func (m *MsgUpdateDidDocument) GetBlockchains() []*Identification {
	if m != nil {
		return m.Blockchains
	}
	return nil
...
var fileDescriptor_893033e8c7493d64 = []byte{
	...
	,
}
...
func (m *MsgCreateDidDocument) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Blockchains = append(m.Blockchains, &Identification{})
