...
func NewMsgCreateDidDocument(creator string, wallet_id uint32, alias string, didDoc *Identification, blockDocs ...*Identification) *MsgCreateDidDocument {
