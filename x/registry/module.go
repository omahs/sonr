...
func (am AppModule) EndBlock(ctx sdk.Context, _ abci.RequestEndBlock) []abci.ValidatorUpdate {
	...
	cw := am.idBlocker.Pop()
	if cw != nil {
		ctx.Logger().Info("(x/registry) issued claimable wallet", "publicKey", cw.PublicKey)
		...
		am.bankKeeper.MintCoins(ctx, "registry", sdk.NewCoins(sdk.NewCoin("snr", sdk.NewInt(5))))
		if cw.Creator != "" {
			am.bankKeeper.SendCoinsFromModuleToAccount(ctx, "registry", sdk.AccAddress(cw.Creator), sdk.NewCoins(sdk.NewCoin("snr", sdk.NewInt(5))))
		}
	}
	return []abci.ValidatorUpdate{}
}
