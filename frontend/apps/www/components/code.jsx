    ...
    <button
      ...
      className={clsx(
        ...
        copied
          ...
          : 'bg-background hover:bg-muted dark:bg-background/2.5 dark:hover:bg-muted/5'
      )}
      onClick={() => {
...
export function CodeGroup({ children, title, ...props }) {
  ...
  return (
    <CodeGroupContext.Provider value={true}>
      <Container
        {...containerProps}
        className="not-prose my-6 overflow-hidden rounded-2xl shadow-md dark:ring-1 dark:ring-white/10"
      >
